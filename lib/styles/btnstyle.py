...
class ActionButton(tk.Button):
    ...
    def __init__(self, master, text, command, colors, btn_type='primary', **kwargs):
        ...
        self.hover_fg = 'white'
        super().__init__(master, text=text, command=command, font=('Segoe UI', 9, 'bold'), bg=self.bg_color, fg=self.accent_color, activebackground=self.hover_bg, activeforeground=self.hover_fg, bd=0, padx=20, pady=8, cursor='hand2', relief='flat', **kwargs)
...
if __name__ == '__main__':
    ...
    theme_colors = {'sidebar': '#252526', 'danger': '#f44336', 'success': '#4caf50', 'primary': '#007acc', 'warning': '#ff9800'}
