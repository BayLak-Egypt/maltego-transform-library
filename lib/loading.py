...
# --- الجزء الأول: محرك العمل في الخلفية (Worker) ---
...
# --- الجزء الثاني: واجهة التحميل الرسومية (GUI) ---
class MaltegoGUILoader(QWidget):
    ...
    def initUI(self):
        ...
        # تطبيق الألوان المستوردة في الـ StyleSheet
        ...
        # استخدام لون الـ accent للعناوين
        ...
        # استخدام لون text_dim للنصوص الثانوية
...
# --- الجزء الثالث: الدوال التي يتم استدعاؤها من الخارج (API) ---

def start_loader(tasks):
    """تشغيل واجهة التحميل الرسومية"""
...
def run_terminal_loader(tasks):
    """نسخة التيرمينال (تم تحديث الألوان النصية هنا أيضاً)"""
    print("\n" + "="*50)
